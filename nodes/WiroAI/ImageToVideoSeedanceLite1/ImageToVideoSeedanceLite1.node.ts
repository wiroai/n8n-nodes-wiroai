...
export class ImageToVideoSeedanceLite1 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Image To Video Seedance Lite V1',
		name: 'imageToVideoSeedanceLite1',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'An image-to-video generation model that offers 5s or 10s videos, at 480p and 720p resolution',
		defaults: {
			name: 'Wiro - Image To Video Seedance Lite V1',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/ByteDance/image-to-video-seedance-lite-v1',
			headers: {
				...headers,
