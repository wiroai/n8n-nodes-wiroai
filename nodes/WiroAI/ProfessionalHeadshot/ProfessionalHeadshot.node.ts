...
export class ProfessionalHeadshot implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Professional Headshot',
		name: 'professionalHeadshot',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Create polished professional headshots instantly.  Our image-to-image AI refines your photos in',
		defaults: {
			name: 'Wiro - Professional Headshot',
		},
		...
		properties: [
			...
			},
			{
				...
				default: 'black',
				required: true,
				description: 'Select option for background',
				options: [
