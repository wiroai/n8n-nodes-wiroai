...
export class TrainSdxlLora implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Train Sdxl Lora',
		name: 'trainSdxlLora',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'LoRA training is a low-rank adaptation technique used to fine-tune Stable Diffusion XL (SDXL) m',
		defaults: {
			name: 'Wiro - Train Sdxl Lora',
		},
