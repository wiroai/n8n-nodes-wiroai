...
export class AiResumeCvEvaluatorSkillsets implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Ai Resume Cv Evaluator Skillsets',
		name: 'aiResumeCvEvaluatorSkillsets',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Wiro/AI-Resume-CV-Evaluator-SkillSet enables you to analyze and score resumes (CVs) based on sp',
		defaults: {
			name: 'Wiro - Ai Resume Cv Evaluator Skillsets',
		},
		...
		properties: [
			...
			},
			{
				...
				default: '',
				required: true,
				description: 'Enter the skill keywords separated by comma ( , ). Ensure the skillset is clear and related with each other to attract the right candidates.',
			},
			{
