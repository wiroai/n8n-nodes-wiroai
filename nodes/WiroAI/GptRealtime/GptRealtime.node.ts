...
export class GptRealtime implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - GPT Realtime Voice Assistant - OpenAI Model',
		name: 'gptRealtime',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'GPT Realtime enables low-latency, bidirectional streaming for voice and text. Build interactive',
		defaults: {
			name: 'Wiro - GPT Realtime Voice Assistant - OpenAI Model',
		},
