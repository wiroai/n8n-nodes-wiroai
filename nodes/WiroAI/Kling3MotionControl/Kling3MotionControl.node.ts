...
export class Kling3MotionControl implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Kling V3 Motion Control',
		name: 'kling3MotionControl',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Generate high-quality image-to-video content with Kling V3 Motion Control. Customize video mode',
		defaults: {
			name: 'Wiro - Kling V3 Motion Control',
		},
