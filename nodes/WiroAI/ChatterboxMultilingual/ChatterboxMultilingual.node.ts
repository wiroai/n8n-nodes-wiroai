...
export class ChatterboxMultilingual implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Chatterbox Multilingual',
		name: 'chatterboxMultilingual',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Generate expressive, natural speech in 23 languages. Features instant voice cloning from short',
		defaults: {
			name: 'Wiro - Chatterbox Multilingual',
		},
		...
		properties: [
			...
			},
			{
				...
				default: 'ar',
				required: true,
				description: 'Select option for language',
				options: [
