...
export class Gpt5Nano implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - GPT-5 Nano AI Model',
		name: 'gpt5Nano',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Access GPT-5 Nano API by OpenAI on Wiro. Simple integration, transparent pricing, and comprehen',
		defaults: {
			name: 'Wiro - GPT-5 Nano AI Model',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/openai/gpt-5-nano',
			headers: {
				...headers,
