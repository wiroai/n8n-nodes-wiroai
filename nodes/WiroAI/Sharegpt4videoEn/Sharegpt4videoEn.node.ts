...
export class Sharegpt4videoEn implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Sharegpt4Video En',
		name: 'sharegpt4videoEn',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Video to text ai tool',
		defaults: {
			name: 'Wiro - Sharegpt4Video En',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const response = await this.helpers.request({
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/wiro/ShareGPT4Video-EN',
			headers: {
				...headers,
