...
export class Seed2Mini implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Seed-V2 Mini LLM',
		name: 'seed2Mini',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Explore the Seed-V2 Mini LLM by ByteDance, designed for efficient AI inference and NLP tasks. P',
		defaults: {
			name: 'Wiro - Seed-V2 Mini LLM',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/bytedance/seed-v2-mini',
			headers: {
				...headers,
