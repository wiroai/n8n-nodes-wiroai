...
export class TextToVideoKlingai16 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Text To Video Klingai V1 6',
		name: 'textToVideoKlingai16',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'KlingAI v1.6 text to video generation tool. Generate 5s and 10s videos in 720p resolution at 30',
		defaults: {
			name: 'Wiro - Text To Video Klingai V1 6',
		},
