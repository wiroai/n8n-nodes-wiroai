...
export class SeedancePro1 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Seedance Pro V1',
		name: 'seedancePro1',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'An video generation model that offers 5s or 10s videos, at 480p and 1080p resolution',
		defaults: {
			name: 'Wiro - Seedance Pro V1',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/ByteDance/seedance-pro-v1',
			headers: {
				...headers,
