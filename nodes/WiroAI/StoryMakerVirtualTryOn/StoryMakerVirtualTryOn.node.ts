...
export class StoryMakerVirtualTryOn implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Story Maker Virtual Try On',
		name: 'storyMakerVirtualTryOn',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Applies the outfit to the specified model with prompt. Can apply the outfit on the person to th',
		defaults: {
			name: 'Wiro - Story Maker Virtual Try On',
		},
