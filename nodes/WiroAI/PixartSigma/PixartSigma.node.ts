...
export class PixartSigma implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Pixart Sigma',
		name: 'pixartSigma',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixArt-Σ consists of pure transformer blocks for latent diffusion: It can directly generate 102',
		defaults: {
			name: 'Wiro - Pixart Sigma',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/wiro/PixArt-Sigma',
			headers: {
				...headers,
