...
export class TextToVideo35 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Text To Video V3 5',
		name: 'textToVideo35',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixVerse text-to-video model v3.5',
		defaults: {
			name: 'Wiro - Text To Video V3 5',
		},
		...
		properties: [
			...
			},
			{
				...
				default: '1:1',
				required: true,
				description: 'Sets the width-to-height ratio of the output image or video',
				options: [
					{ name: '1:1', value: '1:1' },
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/PixVerse/text-to-video-v3.5',
			headers: {
				...headers,
