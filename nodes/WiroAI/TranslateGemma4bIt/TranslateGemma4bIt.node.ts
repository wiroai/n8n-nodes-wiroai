...
export class TranslateGemma4bIt implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Translate Gemma 4B It',
		name: 'translateGemma4bIt',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Access Translate Gemma 4B API by Google on Wiro. Simple integration, transparent pricing, and c',
		defaults: {
			name: 'Wiro - Translate Gemma 4B It',
		},
