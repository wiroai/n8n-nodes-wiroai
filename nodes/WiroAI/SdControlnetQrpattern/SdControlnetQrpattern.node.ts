...
export class SdControlnetQrpattern implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Sd Controlnet Qrpattern',
		name: 'sdControlnetQrpattern',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'QR code art generator enables the creation of QR code art based on a provided prompt and black',
		defaults: {
			name: 'Wiro - Sd Controlnet Qrpattern',
		},
