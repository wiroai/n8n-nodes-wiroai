...
export class Gpt52 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - GPT-5.2 AI Model',
		name: 'gpt52',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Access GPT-5-2 API by OpenAI on Wiro. Simple integration, transparent pricing, and comprehensiv',
		defaults: {
			name: 'Wiro - GPT-5.2 AI Model',
		},
		...
		properties: [
			...
			},
			{
				...
				type: 'options',
				default: 'high',
				description: 'Optional. Controls reasoning effort level.',
				options: [
