...
export class TextToImageFluxLora implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Text To Image Flux Lora',
		name: 'textToImageFluxLora',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Flux is a tool that generates images from text descriptions. With LoRA models, you can enhance',
		defaults: {
			name: 'Wiro - Text To Image Flux Lora',
		},
