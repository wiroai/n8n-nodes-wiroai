...
export class TextToVideo4 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Text To Video V4',
		name: 'textToVideo4',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixVerse text-to-video model v4',
		defaults: {
			name: 'Wiro - Text To Video V4',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/PixVerse/text-to-video-v4',
			headers: {
				...headers,
