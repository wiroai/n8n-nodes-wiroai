...
export class KolorsInpainting implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Kolors Inpainting',
		name: 'kolorsInpainting',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Kolors Inpatining Tool',
		defaults: {
			name: 'Wiro - Kolors Inpainting',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/wiro/kolors-inpainting',
			headers: {
				...headers,
