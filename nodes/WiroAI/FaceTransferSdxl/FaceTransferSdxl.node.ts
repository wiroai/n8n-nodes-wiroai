...
export class FaceTransferSdxl implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Face Transfer Sdxl',
		name: 'faceTransferSdxl',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Utilizes Stable Diffusion XL to take a photo and create new images by prompt, preserving the or',
		defaults: {
			name: 'Wiro - Face Transfer Sdxl',
		},
