...
export class TranslateGemma12bIt implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Translate Gemma 12B It',
		name: 'translateGemma12bIt',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Access Translate Gemma 12B API by Google on Wiro. Simple integration, transparent pricing, and',
		defaults: {
			name: 'Wiro - Translate Gemma 12B It',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/google/translate-gemma-12b-it',
			headers: {
				...headers,
