...
export class ImageToVideo35 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Image To Video V3 5',
		name: 'imageToVideo35',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixVerse image-to-video model v3.5',
		defaults: {
			name: 'Wiro - Image To Video V3 5',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/PixVerse/image-to-video-v3.5',
			headers: {
				...headers,
