...
export class KolorsIpAdapterFaceIdPlus implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Kolors Ip Adapter Face Id Plus',
		name: 'kolorsIpAdapterFaceIdPlus',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Kolors image-to-image ai tool with use IP Adapter',
		defaults: {
			name: 'Wiro - Kolors Ip Adapter Face Id Plus',
		},
