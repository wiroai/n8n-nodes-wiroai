...
export class ImageToVideo45 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Image To Video V4 5',
		name: 'imageToVideo45',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixVerse image-to-video model v4.5',
		defaults: {
			name: 'Wiro - Image To Video V4 5',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const response = await this.helpers.request({
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/PixVerse/image-to-video-v4.5',
			headers: {
				...headers,
