...
export class HunyuanFluxSrpo implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Hunyuan Flux SRPO',
		name: 'hunyuanFluxSrpo',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'FLUX.1 SRPO [dev] is a 12 billion parameter flow transformer that generates high-quality images',
		defaults: {
			name: 'Wiro - Hunyuan Flux SRPO',
		},
		...
		properties: [
			{
				...
				type: 'string',
				default: '',
				description: '(Optional) Provide an image file or an image URL. If you do not provide an image, the generation process will run only with the prompt.',
			},
			{
				displayName: 'Prompt',
				name: 'prompt',
