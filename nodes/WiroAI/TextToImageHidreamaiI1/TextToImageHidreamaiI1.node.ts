...
export class TextToImageHidreamaiI1 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Text To Image Hidreamai I1',
		name: 'textToImageHidreamaiI1',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'HiDream AI I1 Text to Image Versions',
		defaults: {
			name: 'Wiro - Text To Image Hidreamai I1',
		},
		...
		properties: [
			...
			},
			{
				...
				type: 'number',
				default: 0,
				description: 'Scale for classifier-free guidance. (use 5.0 for Full).',
			},
			{
				displayName: 'Flow Shift',
				name: 'flowShift',
				type: 'number',
				default: 0,
				description: 'Adjust timing or order of processing',
			},
			{
				displayName: 'Samples',
				name: 'samples',
				type: 'number',
				default: 0,
				description: 'Number of samples to process or generate',
			},
			{
				displayName: 'Seed',
				name: 'seed',
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const flowShift = this.getNodeParameter('flowShift', 0, 0) as number;
