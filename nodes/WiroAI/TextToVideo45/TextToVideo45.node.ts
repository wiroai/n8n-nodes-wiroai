...
export class TextToVideo45 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Text To Video V4 5',
		name: 'textToVideo45',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixVerse text-to-video model v4.5',
		defaults: {
			name: 'Wiro - Text To Video V4 5',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/PixVerse/text-to-video-v4.5',
			headers: {
				...headers,
