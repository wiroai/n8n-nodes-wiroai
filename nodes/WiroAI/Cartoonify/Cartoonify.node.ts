...
export class Cartoonify implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Cartoonify',
		name: 'cartoonify',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Turn your photos into fun, vibrant cartoons! This AI model instantly cartoonifies your images,',
		defaults: {
			name: 'Wiro - Cartoonify',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/wiro/cartoonify',
			headers: {
				...headers,
