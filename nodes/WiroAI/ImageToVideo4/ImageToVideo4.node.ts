...
export class ImageToVideo4 implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Image To Video V4',
		name: 'imageToVideo4',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'PixVerse image-to-video model v4 test',
		defaults: {
			name: 'Wiro - Image To Video V4',
		},
		...
		properties: [
			...
			},
			{
				...
				default: '5',
				required: true,
				description: 'Sets duration of the video',
				options: [
					{ name: '5', value: '5' },
					{ name: '8', value: '8' },
				],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/PixVerse/image-to-video-v4',
			headers: {
				...headers,
