...
export class ImageToSongAceStep135b implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Image To Song',
		name: 'imageToSongAceStep135b',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Generate high-quality songs from image in seconds. Whether you\'re crafting instrumental tracks',
		defaults: {
			name: 'Wiro - Image To Song',
		},
