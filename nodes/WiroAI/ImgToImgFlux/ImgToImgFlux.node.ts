...
export class ImgToImgFlux implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Img To Img Flux',
		name: 'imgToImgFlux',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'This is an FLUX1.0 image to image tool',
		defaults: {
			name: 'Wiro - Img To Img Flux',
		},
