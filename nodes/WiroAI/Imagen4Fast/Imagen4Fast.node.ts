...
export class Imagen4Fast implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Imagen V4 Fast',
		name: 'imagen4Fast',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Use this faster, cost-efficient version of Imagen 4 when speed and affordability matter more th',
		defaults: {
			name: 'Wiro - Imagen V4 Fast',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/google/imagen-v4-fast',
			headers: {
				...headers,
