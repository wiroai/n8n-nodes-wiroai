...
export class Seedream5Lite implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Seedream V5 Lite - Image-to-Image & Text-to-Image Generator',
		name: 'seedream5Lite',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'Use Seedream V5 Lite for AI-powered image generation. Transform images or create new ones from',
		defaults: {
			name: 'Wiro - Seedream V5 Lite - Image-to-Image & Text-to-Image Generator',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/ByteDance/seedream-v5-lite',
			headers: {
				...headers,
