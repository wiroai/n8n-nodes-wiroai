...
export class Videollama37b implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Wiro - Videollama3 7B',
		name: 'videollama37b',
		icon: { light: 'file:wiro.svg', dark: 'file:wiro.svg' },
		group: ['transform'],
		version: 1,
		description: 'VideoLLaMA3-7B is a model designed for video understanding',
		defaults: {
			name: 'Wiro - Videollama3 7B',
		},
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const headers = generateWiroAuthHeaders(apiKey, apiSecret);
			...
			method: 'POST',
			url: 'https://api.wiro.ai/v1/Run/wiro/VideoLLaMA3-7B',
			headers: {
				...headers,
